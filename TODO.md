...
- [ ] Fix template rendering error in HTMX stipend create route
- [ ] Verify _stipend_row.html template path in create route
- [ ] Update test_create_stipend_route_htmx to handle template path issues
