...
def test_create_stipend(test_client, session):
...
def test_update_stipend(test_client, session):
...
def test_delete_stipend(test_client, session):
    # Create a stipend first
    stipend = Stipend(
        name='Sample Stipend',
        summary='Sample summary',
...
def test_create_tag(test_client, session):
...
def test_update_tag(test_client, session):
    # Create a tag first
...
def test_delete_tag(test_client, session):
    # Create a tag first
    tag = Tag(name='Sample Tag', category='Category')
    session.add(tag)
    session.commit()
...
def test_create_organization(test_client, session):
...
def test_update_organization(test_client, session):
...
def test_delete_organization(test_client, session):
    # Create an organization first
    organization = Organization(
        name='Sample Organization',
        description='Sample description',
...
def test_create_bot(test_client, session):
...
def test_update_bot(test_client, session):
    # Create a bot first
...
def test_delete_bot(test_client, session):
    # Create a bot first
    bot = Bot(name='Sample Bot', description='Sample description', status='active')
    session.add(bot)
    session.commit()
...
def test_create_notification(test_client, session):
...
def test_update_notification(test_client, session):
...
def test_delete_notification(test_client, session):
    # Create a notification first
    notification = Notification(message='Sample notification', type='info')
    session.add(notification)
    session.commit()
