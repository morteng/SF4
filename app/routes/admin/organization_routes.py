        ...
        for field_name, errors in form.errors.items():
            ...
            for error in errors:
                if field_name == 'name' and 'This field is required.' in error:
                    ...
                    flash_message("Org Name: Organization name must contain only letters, numbers, and spaces.", FLASH_CATEGORY_ERROR)
                elif field_name == 'name' and 'Organization with this name already exists.' in error:
                    flash_message("Org Name: Organization with this name already exists.", FLASH_CATEGORY_ERROR)
                else:
