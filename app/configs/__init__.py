...
class ProductionConfig(BaseConfig):
    ...
    DEBUG: bool = False
    TESTING: bool = False
    SQLALCHEMY_DATABASE_URI: str = os.getenv("DATABASE_URL", "sqlite:///production.db")

class DevelopmentConfig(BaseConfig):
    """Development configuration."""
    DEBUG: bool = True
    TESTING: bool = False
    SQLALCHEMY_DATABASE_URI: str = os.getenv("DATABASE_URL", "sqlite:///development.db")
...
__all__ = ['BaseConfig', 'ProductionConfig', 'DevelopmentConfig', 'TestingConfig']
