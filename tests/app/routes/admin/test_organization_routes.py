...
class TestOrganizationRoutes:
    ...
    def test_create_organization(self, logged_in_client, app, db):
    ...
    def test_update_organization(self, logged_in_client, app, db):
    ...
    def test_delete_organization(self, logged_in_client, app, db):
        # Create an organization first
        with app.app_context():
